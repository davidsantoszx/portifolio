    ...
    return (
      ...
      <section id="certs" className="max-w-5xl mx-auto px-6 py-24 fade-in-section">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="p-6 border transition-all hover:-translate-y-1 bg-[color:var(--color-background)] border-[color:var(--color-text-muted)] hover:border-[color:var(--color-primary)]">
          ...
          <div className="space-y-3.5">
            <div className="p-4 border flex items-center justify-between hover:-translate-y-1  transition-all duration-300 bg-[color:var(--color-background)] border-[color:var(--color-text-muted)] hover:border-[color:var(--color-primary)]">
              <div>
          ...
          <div
            className="p-4 border flex items-center justify-between hover:-translate-y-1 transition-all duration-300 bg-[color:var(--color-background)] border-[color:var(--color-text-muted)] hover:border-[color:var(--color-primary)]">
            <div>
