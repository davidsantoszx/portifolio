    ...
    return (
      ...
      <section id="certs" className="max-w-5xl mx-auto px-6 py-24 fade-in-section">
        <div className="text-center mb-16 space-y-3">
          ...
          <p className="text-[color:var(--text-secondary)] max-w-xl mx-auto text-sm">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className={`p-6 border transition-all ${isDarkMode ? 'bg-[color:var(--surface)]/30 border-[color:var(--border)]' : 'bg-white border-neutral-200'}`} style={{ borderRadius: '2px' }}>
            <div className="flex items-start justify-between mb-4">
              ...
              <span className="px-2.5 py-0.5 text-[9px] font-mono border border-neutral-500/30 text-[color:var(--text-secondary)] bg-[var(--primary)]/5 rounded-full uppercase">
                Concluído
              </span>
            </div>
            <p className="text-xs md:text-sm font-semibold opacity-80">Unopar</p>
            <p className="text-xs md:text-sm text-[color:var(--text-secondary)] mt-4 leading-relaxed">
          ...
          <div className="space-y-3.5">
            <div className={`p-4 border flex items-center justify-between hover:-translate-y-1 hover:border-[var(--primary)] transition-all duration-300 ${isDarkMode ? 'bg-[color:var(--surface)]/30 border-[color:var(--border)]'    : 'bg-white border-neutral-200'}`}style={{ borderRadius: '2px' }}>
              <div>
           ...
           <div className={`p-4 border flex items-center justify-between hover:-translate-y-1 hover:border-[var(--primary)] transition-all duration-300 ${isDarkMode ? 'bg-[color:var(--surface)]/30 border-[color:var(--border)]'    : 'bg-white border-neutral-200'}`}style={{ borderRadius: '2px' }}>
            ...
            <div className={`p-4 border flex items-center justify-between hover:-translate-y-1 hover:border-[var(--primary)] transition-all duration-300 ${isDarkMode ? 'bg-[color:var(--surface)]/30 border-[color:var(--border)]'    : 'bg-white border-neutral-200'}`}style={{ borderRadius: '2px' }}>
              ...
              <span className="p-1.5 rounded bg-[color:var(--primary)]/10 text-[color:var(--text-secondary)] font-mono text-[9px]">Fundação Bradesco</span>
            </div>
          </div>


          <div
            className={`p-4 border flex items-center justify-between hover:-translate-y-    hover:border-[var(--primary)]  transition-all duration-300  ${isDarkMode  ? 'bg-[color:var(--surface)]/30 border-[color:var(--border)]'     : 'bg-white border-neutral-200'}`}    style={{ borderRadius: '2px' }}>
            <div>
              <h4 className="text-xs md:text-sm font-bold">
                Backend Python Django
              </h4>

              <p className="text-[11px] text-[color:var(--text-secondary)] font-mono mt-0.5">
            ...
            <span className="px-2 py-1 rounded bg-[color:var(--primary)]/10 text-[color:var(--text-secondary)] font-mono text-[9px]">
              Udemy
            </span>
          </div>
